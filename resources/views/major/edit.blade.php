        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form action="{{ url('major/' . $major->kode_jurusan) }}" method="post">
                            @method('patch')
                            @csrf
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="kode_jurusan" name="kode_jurusan" value="{{ $major->kode_jurusan }}">
                                        @error('kode_jurusan')
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="nama_jurusan" name="nama_jurusan" value="{{ $major->nama_jurusan }}">
                                        @error('nama_jurusan')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
