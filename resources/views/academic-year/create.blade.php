                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" placeholder="Start date" type="text"
                                                        name="tanggal_awal_uts" value="{{ old('tanggal_awal_uts') }}">
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" placeholder="End date" type="text"
                                                        name="tanggal_akhir_uts" value="{{ old('tanggal_akhir_uts') }}">
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" placeholder="Start date" type="text"
                                                        name="tanggal_awal_uas" value="{{ old('tanggal_awal_uas') }}">
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" placeholder="End date" type="text"
                                                        name="tanggal_akhir_uas" value="{{ old('tanggal_akhir_uas') }}">
                                                </div>
