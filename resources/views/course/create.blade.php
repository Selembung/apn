                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="form-control-label " for="kode_mp">Kode Mata Kuliah</label>
                                        <input type="text" class="form-control @error('kode_mp') is-invalid @enderror"
                                            id="kode_mp" name="kode_mp" value="{{ old('kode_mp') }}">
                                        @error('kode_mp')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="nama_mp">Nama Mata Kuliah</label>
                                        <input type="text" class="form-control  @error('nama_mp') is-invalid @enderror"
                                            id="nama_mp" name="nama_mp" value="{{ old('nama_mp') }}">
                                        @error('nama_mp')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="muatan" name="muatan">
                                            ...
                                            <option value="A" {{ old('muatan') == "A" ? 'selected' : '' }}>
                                                Muatan Nasional</option>
                                            <option value="B" {{ old('muatan') == "B" ? 'selected' : '' }}>
                                                Muatan Kewilayahan</option>
                                            <option value="C" {{ old('muatan') == "C" ? 'selected' : '' }}>
