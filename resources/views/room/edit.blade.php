        ...
        <div class="col-lg-12">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form action="{{ url('room/' . $room->kode_ruangan) }}" method="post">
                            @method('patch')
                            @csrf
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="kode_ruangan" name="kode_ruangan" value="{{ $room->kode_ruangan }}">
                                        @error('kode_ruangan')
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="nama_ruangan" name="nama_ruangan" value="{{ $room->nama_ruangan }}">
                                        @error('nama_ruangan')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
